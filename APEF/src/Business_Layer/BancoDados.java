...
public class BancoDados {
	...
	public BancoDados(BancoDados a) {
	...
	public String toString() {
		...
		str.append(this.getEpoca() + "\n");
		str.append(this.getEscolas() + "\n");
		str.append(this.getUsers() + "\n");
