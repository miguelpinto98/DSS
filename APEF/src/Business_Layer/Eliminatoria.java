...
public class Eliminatoria extends Fase {    
    ...
    public void geraCalendario(int idComp, GregorianCalendar dataInicio, ArrayList<Utilizador> arbitros, ArrayList<Integer> equipas1, ArrayList<Integer> equipas2, Campo x) {
