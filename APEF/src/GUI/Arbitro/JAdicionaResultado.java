...
public class JAdicionaResultado extends javax.swing.JDialog {
    ...
    public JAdicionaResultado(Home2 h) {
        this.home2=h;
        initComponents();
    }
    
    public String seleccionadoJogo(){
        String s;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Jogos arbitrados");

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jButton1.setText("Adicionar Resultado");
