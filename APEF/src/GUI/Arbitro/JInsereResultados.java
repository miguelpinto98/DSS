...
public class JInsereResultados extends javax.swing.JDialog {

    JAgenda a;
    
    public JInsereResultados(JAgenda j) {
        this.a=j;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!(jTextField1.getText().equals("0")) || !(jTextField2.getText().equals("0"))){
             ...
             this.jPanel4.add(new JJogadores(this), BorderLayout.CENTER);
