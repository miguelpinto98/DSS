 ...
 * @author Diana
 */
public class JInscreverEquipa extends JDialog {
    private JOptions o;
    
    public JInscreverEquipa(JOptions j) {
        initComponents();
         this.o = j;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inscrever equipa no torneio");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Escalão " }));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("Seleccione jogadores:");
