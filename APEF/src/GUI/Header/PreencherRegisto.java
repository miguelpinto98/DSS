 ...
 * @author Diana
 */
public class PreencherRegisto extends javax.swing.JDialog {

    /**
     * Creates new form PreencherRegisto
     */
    public PreencherRegisto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(524, 329));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreencherRegisto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PreencherRegisto dialog = new PreencherRegisto(new javax.swing.JFrame(), true);
