 ...
 * @author miguelpinto
 */
public final class JAdicionarJogador extends javax.swing.JDialog {

    private Home2 root;
    private Escalao escalao;
    private JPlantelJogador jpc;

    public JAdicionarJogador(Home2 root, Escalao escalao, JPlantelJogador ce) {
        this.root = root;
    ...
    private void initComponents() {
        ...
        setTitle("APEF - Adicionar Jogador");
        setResizable(false);
        ...
        title.setText("Adicionar Novo Jogador");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Jogador"));
    ...
    private void criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarActionPerformed
        ...
        if(res) {
            ...
            this.error.setText("Jogador Inválido");
        }  
