 ...
 * @author miguelpinto
 */
public final class JRemoverPlantel extends javax.swing.JDialog {
    ...
    public JRemoverPlantel(Home2 root, Escalao esc, Equipa equipa, ConsultasEscola ce) {
        this.root = root;
        this.escalao = esc;
        this.equipa = equipa;
        this.ce = ce;
        ...
        this.textEscalao.setText(this.ce.devolveEscalaoTipo(this.escalao.getTipoEscalao()));  
    }
    ...
    private void initComponents() {
        ...
        textEscalao = new javax.swing.JLabel();
        ...
        title.setText("Confirmar Remover Plantel");

        textEscalao.setFont(new java.awt.Font("Lucida Grande", 3, 18)); // NOI18N
        textEscalao.setText("Escalao");
        textEscalao.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(textEscalao, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(error, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarActionPerformed
        ...
        if(!this.escalao.getJogadores().isEmpty())
            this.error.setText("Remover jogadores primeiro");
        else {
            this.equipa.removerEscalao(this.escalao);
            this.ce.devolveComboEscalao().removeItem(this.escalao);
            this.ce.reloadPanelEquipaGeral(this.equipa.getNome());
    ...
    private javax.swing.JLabel textEscalao;
